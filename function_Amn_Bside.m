function [A_mn_sum, A_mn_matrix]=function_Amn_Bside(p_BS, centers_IRS, p_vehicle_trajectory, total_time)
...
G_IRS_to_BS_direction = function_gain_IRS(centers_IRS, p_BS);
...
for t = 1 : total_time
    ...
    %"function_gain_IRS" to calculate the gain. 
    temp_G_IRS_to_Vehicle_direction = function_gain_IRS(centers_IRS , p_vehicle_trajectory(t,:));
